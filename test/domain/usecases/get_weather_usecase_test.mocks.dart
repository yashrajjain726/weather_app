...
// in weather_app/test/domain/usecases/get_weather_usecase_test.dart.
...
import 'package:weather_app/features/domain/entities/weather.dart' as _i6;
...
class MockWeatherRepository extends _i1.Mock implements _i3.WeatherRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.Weather>> getWeatherData(
          _i7.Position? position) =>
      (super.noSuchMethod(
        Invocation.method(
          #getWeatherData,
          [position],
